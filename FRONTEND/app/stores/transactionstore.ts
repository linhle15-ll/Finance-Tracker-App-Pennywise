...
export const addIncome = async(e:any) => {
    ...
    try {
        const res = await axios.post('https://pennywise-backend-linhle.vercel.app/add-income', newFormData , {
...
export const getIncomes = async() => {
    ...
    try {
        const res = await axios.get('https://pennywise-backend-linhle.vercel.app/get-incomes');
...
export const deleteIncome = async (id) => {
    try {
        const res = await axios.delete(`https://pennywise-backend-linhle.vercel.app/delete-income/${id}`);
...
export const addExpense = async (e) => {
    ...
    try {
        const res = await axios.post('https://pennywise-backend-linhle.vercel.app/add-expense', newFormData , {
            headers: { 'Content-Type': 'application/json' },
        });
...
export const getExpenses = async() => {
    try {
        const res = await axios.get('https://pennywise-backend-linhle.vercel.app/get-expenses');
...
export const deleteExpense = async(id) => {
    try {
        const res = await axios.delete(`https://pennywise-backend-linhle.vercel.app/delete-expense/${id}`);
